...
include('header.php');?>
 ...
 <?php if(isset($_GET['reg'] ) && ($_GET['reg'] == 1)  ){
		            echo '<div class="alert alert-success text-center" role="alert"> User Details Registered Successfully </div>';
			   }
...
<form class="signin-form" action="login_submit.php" method="POST"  >
    ...
    <a class="btn btn-secondary" type="submit" style="outline: none;" >
      <span class="group">
        ...
        <div class="w-50">
                <a href="userdetails.php" class="checkbox-wrap checkbox-primary">Sign Up
